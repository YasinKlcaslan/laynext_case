...
export default function MainPage() {
  return (
    <section className="bg-[#fef7f6] pt-32">
      <div className="mx-auto grid max-w-7xl items-center gap-32 px-6 lg:grid-cols-2 lg:px-8">

        <div>
          <h1 className="text-6xl font-semibold leading-[1.5] text-black">
            Find
            <span className="text-[#FF725E] font-bold"> Match Now </span>
            and Grow Your Feelings
          </h1>

          <p className="mt-8 max-w-xl text-lg leading-9 text-[#959393]">
          ...
          <div className="mt-12 inline-flex gap-4 rounded-3xl p-2 bg-white md:flex-row md:items-center">
            ...
            <button className="rounded-lg bg-[#FF725E] border border-white px-4 py-3 text-sm text-white transition-all duration-300 hover:bg-white hover:text-[#FF725E] hover:border-[#FF725E]">
              Find Now
            </button>
          </div>
        </div>
